...
\vspace{2em}
\begin{center}
      %\only<1>{\includegraphics[height=5cm]{figures/pcp/scores_plot.pdf}}
      \only<1>{\includegraphics[height=5cm]{figures/pcp/loadings_plot.pdf}}
      %\only<2>{\includegraphics[height=5cm]{figures/patscore2.png}}
      \only<2>{\includegraphics[height=5cm]{figures/pcp/sim_corr.pdf}}
\end{center}
\end{columns}
}
